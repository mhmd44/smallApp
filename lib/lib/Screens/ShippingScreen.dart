  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(!widget.ask ? "بيانات الشحن": "عرض سعر",style: TextStyle(color: Colors.white),),
        centerTitle: true,
      ),
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              SizedBox(height: 20,),
              Text(!widget.ask ? "برجاء ادخال بيانات الشحن":"برجاء ادخال بيانات التواصل",textDirection: TextDirection.rtl,style: TextStyle(color: Colors.red,fontSize: 18,fontWeight: FontWeight.bold),),
              SizedBox(height: 10,),
              Container(
                height: 70,
                width: 70,
                ...
                onTap: (){
                  if(widget.ask == true){
                   ...
                   showDialog(context: context, builder: (context){
                     return AlertDialog(
                       content: Text('يجب اضافة جميع البيانات'),
                       actions: [IconButton(onPressed: (){
                         Navigator.pop(context);
                       }, icon: Text('تم',style: TextStyle(color: Colors.red,fontSize: 18),))],
                     );
                   });
